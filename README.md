...
| [KiCad](https://kicad.org/) $\color{orange}A$ | Free | Win, Linux | One of the most popular Open source EDA package with push and shove router, differential pairs and much more. | :x: | :x: | :heavy_check_mark: | :heavy_check_mark: |
